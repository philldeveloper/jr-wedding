                ...
                <div class="d-flex w-50 justify-content-between align-items-center">
                    ...
                    <div>
                        <a class="navbar-brand" href="{{ url('/') }}">
                            <img src="{{asset('img/jr-weeding.png')}}" alt="" width="60px">
                        </a>
                    </div>
                    
                    <div>
                        <a class="nav-link lead bg-wedding rounded text-light">
                            <i class="fas fa-exclamation-circle text-light pr-2"></i>
                            Faltam 300 Dias
                        </a>
                    </div>
                </div>
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre 
                                   style="font-size: 15pt">
                                    Bem vindo, <b>{{ Auth::user()->name }}</b> <span class="caret"></span>
                                </a>
